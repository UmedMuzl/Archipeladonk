...
def apply_archipelago_settings(settings_dict: dict, options, multiworld) -> None:
    ...
    if options.tooie_style_shops.value:
        ...
        # Use medium prices as the base - this generates random prices by location (not by item)
        # so filler items in shops will have actual costs that determineFinalPriceAssortment can work with
